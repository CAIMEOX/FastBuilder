...
console.log(clc.blue('Server is running at ws://' + require('os').networkInterfaces()[Object.keys(require('os').networkInterfaces())[1]][0].address + ':8080'));
console.log(clc.blue(profile.logo));
